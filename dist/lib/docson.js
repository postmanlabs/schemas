...
define(["./jquery", "./handlebars", "./highlight", "./jsonpointer", "./marked", "./traverse"], function(jquery, handlebars, highlight, jsonpointer, marked) {
        ...
        ready.done(function() {
            ...
            var renderBox = function() {
                ...
                element.find(".signature-type-expandable").click(function() {
                    ...
                    if($(this).hasClass("signature-type-expanded")) {
                        $(this).parent().parent().parent().children(".signature-box-container").
                            children("[boxid='"+boxId+"']").slideUp(resizeHandler ? 0 : 200);
                    } else {
                        $(this).parent().parent().parent().children(".signature-box-container").
                            children("[boxid='"+boxId+"']").slideDown(resizeHandler ? 0 : 200);
                    }
