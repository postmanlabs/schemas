...
Repository of all schemas for JSON structures compatible with Postman (such as the Postman Collection Format). The schemas are also hosted online, at [schemas.getpostman.com](https://schemas.getpostman.com). 
